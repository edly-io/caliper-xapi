...
from edx_analytics_transformers.backends.async_routing import AsyncRoutingBackend
...
class TestAsyncRoutingBackend(TestCase):
    ...
    @patch('edx_analytics_transformers.backends.async_routing.async_send')
    ...
    @patch('edx_analytics_transformers.backends.async_routing.LOG')
    @patch('edx_analytics_transformers.backends.async_routing.json.dumps', side_effect=ValueError)
    @patch('edx_analytics_transformers.backends.async_routing.async_send')
    ...
    @patch('edx_analytics_transformers.backends.async_routing.LOG')
    @patch('edx_analytics_transformers.backends.async_routing.async_send.delay')
    def test_with_value_error_in_one_backend_json_encoding(self, mocked_async_send, mocked_log):
        ...
        with patch('edx_analytics_transformers.backends.async_routing.json.dumps') as mocked_json_dumps:
