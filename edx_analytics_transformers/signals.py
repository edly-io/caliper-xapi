...
from edx_analytics_transformers.django.models import RouterConfiguration, ROUTER_CACHE_NAMESPACE


logger = getLogger(__name__)


@receiver([post_save, post_delete], sender=RouterConfiguration)
def invalidate_backend_router_cache(instance, *args, **kwargs):   # pylint: disable=unused-argument
    ...
    Arguments:
        instance (RouterConfiguration):      Instance being updated/created or deleted
    """
