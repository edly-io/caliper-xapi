...
from edx_analytics_transformers.django.django_tracker import DjangoTracker, override_default_tracker
...
class TestConfiguration(TestCase):
    ...
    @override_settings(EVENT_TRACKING_BACKENDS={
        "fake": {
            'ENGINE': 'edx_analytics_transformers.django.tests.test_configuration.TrivialFakeBackend'
        }
    })
    ...
    @override_settings(EVENT_TRACKING_BACKENDS={
        "invalid_class": {
            'ENGINE': 'edx_analytics_transformers.django.tests.test_configuration.BarBackend'
        }
    })
    ...
    @override_settings(EVENT_TRACKING_BACKENDS={
        'with_options': {
            'ENGINE': 'edx_analytics_transformers.django.tests.test_configuration.FakeBackendWithOptions',
            'OPTIONS': {
    ...
    @override_settings(EVENT_TRACKING_BACKENDS={
        'extra_options': {
            'ENGINE': 'edx_analytics_transformers.django.tests.test_configuration.NotABackend'
        }
    })
    ...
    @override_settings(EVENT_TRACKING_BACKENDS={
        'outer_backend': {
            'ENGINE': 'edx_analytics_transformers.django.tests.test_configuration.NestedBackend',
            'OPTIONS': {
                'backends': {
                    'inner_backend': {
                        'ENGINE': 'edx_analytics_transformers.django.tests.test_configuration.FakeBackendWithOptions',
                    ...
                    'nested_backend': {
                        ...
                        'OPTIONS': {
                            ...
                            'processors': [
                                {'ENGINE': 'edx_analytics_transformers.django.tests.test_configuration.NopProcessor'},
                            ]
                        }
                    }
                },
    ...
    @override_settings(EVENT_TRACKING_PROCESSORS=[
        {
            'ENGINE': 'edx_analytics_transformers.django.tests.test_configuration.ProcessorWithOptions',
            'OPTIONS': {
                'option': sentinel.option_value
            }
        }
