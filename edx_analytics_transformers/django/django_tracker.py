...
from edx_analytics_transformers.locator import ThreadLocalContextLocator


default_app_config = 'edx_analytics_transformers.django.apps.edx_analytics_transformersConfig'
...
class DjangoTracker(Tracker):
    """
    A `edx_analytics_transformers.tracker.Tracker` that constructs its backends from
    Django settings.
    """
