...
class LrsClient:
    ...
    def __init__(self, url=None, version='', auth_scheme='', auth_key=''):
        """
    ...
    def get_auth_header_value(self):
        ...
        """
        if self.AUTH_SCHEME:
            return '{} {}'.format(self.AUTH_SCHEME, self.AUTH_KEY)
    ...
    def send(self, statement):
        ...
        if not response:
            logger.exception('Statement could not be sent to %s', self.URL, exc_info=True)
